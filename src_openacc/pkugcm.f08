...
!$acc end kernels
      ...
      ! ALL pure subroutines
      call sp2fc_1lev_acc(sp,gp,        qi,nlon,nlat,nhpp,ntp1,ncsp)                          ! lnPs
      call sp2fcdmu_1lev_acc(sp,gpj,    qj,nlon,nlat,nhpp,ntp1,ncsp)                          ! d(lnPs) / d(mu)
      ...
      ! ALL pure subroutines
      call fc2gp_acc(gu  ,NLON,NLAT*NLEV,trigs)
      call fc2gp_acc(gv  ,NLON,NLAT*NLEV,trigs)
      call fc2gp_acc(gt  ,NLON,NLAT*NLEV,trigs)
      call fc2gp_acc(gd  ,NLON,NLAT*NLEV,trigs)
      call fc2gp_acc(gz  ,NLON,NLAT*NLEV,trigs)
      call fc2gp_acc(gpj ,NLON,NLAT,trigs)
      call fc2gp_acc(gpmt,NLON,NLAT,trigs)
      ...
      ! ALL pure subroutines
      call gp2fc_acc(gtn ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gut ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gvt ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gfv ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gfu ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gke ,NLON,NLAT*NLEV,trigs)
      call gp2fc_acc(gvpp,NLON,NLAT     ,trigs)

      ! ALL pure subroutines
      !call fc2sp(gvpp,spf)       ! 这里是spf的关键点
      call fc2sp_1lev_acc(gvpp,spt,     qc,nlon,nlat,nhpp,ntp1,ncsp)       ! 这里是spf的关键点
